...
--   (other than those generated by system commands).  For example,
--   'putLoud' means that a message will only be emitted WHEN the
--   verbosity is 'Loud'.  Chatty, verbose logging should be emitted
--   with 'putLoud', whereas important messages should be emitted
--   with 'putQuiet'.
