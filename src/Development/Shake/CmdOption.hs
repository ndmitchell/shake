...
data CmdOption
    ...
    | Shell -- ^ Pass the command to the shell - any arguments will be escaped by 'showCommandForUser'.
    | RawShell -- ^ Pass the command to the shell without escaping - any arguments will be joined with spaces.
