...
skip_m ask old r = all ((<= built old) . built . ask) (depends old)
\end{code}
...
\item [Eq] We require equality to look up results for |keys| and to test if |value|s have changed (\S\ref{sec:unchanging_results}).
