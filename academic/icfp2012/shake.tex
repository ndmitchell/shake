...
In order to do lint checking we assume that the system has been cleaned first, we require a complete build to have been done, then a clean to be performed, then a rebuild to be performed in lint mode.
...
\subsection{Random Interleaving}

It helps! Both checking for correct parallelism, and for speeding things up.
